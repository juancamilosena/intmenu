...
<head>
    ...
    <title>Carta</title>
    <link rel="shortcut icon" href="{{ asset('img/logofinal.png') }}" type="image/x-icon">
...
<body class="carta-body bg-dark">
    <header class="cabecera d-flex flex-column align-items-center" style="background-image: url('{{ asset('img/cabezera05.jpg') }}');">
        <section class="navar">
            <div class="d-flex justify-content-center align-items-center">
                <img src="{{ asset('/img/logofinal.png') }}" alt="Logo">
            </div>
        </section>
    </header>
    ...
    <section class="my-4 d-flex justify-content-center" style="height: 30vh;">
        <div class="mb-3 mb-md-0">
            <button type="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#orden">
                <img class="boton-carrito text-light" src="{{ asset('img/car2.png') }}" alt="">Check out
            </button>
            <a href="/MenuComidas"><img src="{{ asset('img/izquierda.png') }}" alt=""></a>
        </div>
        <div class="mb-3 mb-md-0">
        </div>
    </section>
                ...
                <div class="col-md-3 mb-4">
                    <div class="carta-edit">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-light">Disponible: {{ $product->disponibilidad ? 'Sí' : 'No' }}</p>
                            <button type="button" class="btn btn-warning text-light" data-bs-toggle="modal" data-bs-target="#hamburguesa{{ $product->id }}">
                                Personalizar
                            </button>
                        </div>
                    </div>
                            ...
                            <div class="modal-footer d-flex justify-content-between align-items-center flex-column flex-md-row">
                                ...
                                <div class="mb-3 mb-md-0">
                                    <button type="button" class="btn btn-warning" onclick="document.getElementById('form_carta_{{ $product->id }}').submit();">
                                        <img class="boton-carrito text-light" src="{{ asset('img/agregar-a-carrito-de-compras.png') }}" alt="">Add
                                    </button>
                                </div>
                                <div>
                                    <button type="button" class="btn btn-warning">
                                        <img class="boton-carrito text-light" src="{{ asset('img/cubiertos2.png') }}" alt="">Order
                                    </button>
                                </div>
                            </div>
                        </div>
